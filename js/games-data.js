...
const GAMES = [
  {
    id: 'soldiers-vs-monsters',
    name: 'Binh Lính Chống Quái',
    icon: '&#9876;&#65039;',
    desc: 'Tuyển tân binh, cung thủ, pháp sư... chặn quái vật tràn vào thành. +10000 vàng mỗi giây, càng diệt nhiều quái thì chúng càng mạnh và đông. Đồ hoạ vẽ 100% bằng code.',
    category: 'strategy',
    tags: ['chiến thuật', 'phòng thủ', 'thủ thành'],
    bg: 'linear-gradient(135deg, #141830, #4a3d7a)',
    border: '#ff9f6b',
    file: 'soldiers-vs-monsters.html',
    featured: true
  },
  {
    id: 'plants-vs-zombies',
    name: 'Hoa Chống Zombie',
    icon: '🌻',
    desc: 'Trồng hoa hướng dương, đậu bắn, hạt dẻ... chặn từng đợt zombie ăn não. Đồ hoạ vẽ 100% bằng code, có âm thanh.',
    category: 'strategy',
    tags: ['chiến thuật', 'phòng thủ', 'thẻ bài'],
    bg: 'linear-gradient(135deg, #1b3a1b, #4a7a2a)',
    border: '#8bc34a',
  ...
  },
  {
    ...
    name: 'Claude of Duty',
    icon: '🔫',
    desc: 'Bắn súng góc nhìn thứ nhất 3D (Three.js/WebGL2) — toàn bộ đồ hoạ tạo bằng code, không có file art.',
    category: 'arcade',
    tags: ['bắn súng', '3d', 'hành động'],
    bg: 'linear-gradient(135deg, #1a1a1a, #3a0a0a)',
    border: '#f87171',
    file: 'claude-of-duty/index.html',
    featured: true
  },
  {
    id: 'fishing',
  ...
  },
  {
    ...
    name: 'Săn Khủng Long',
    icon: '🦖',
    desc: '15 map từ Compsognathus đến Khủng Long Thần 100 tỷ HP! Nâng cấp súng, luyện sát thương!',
    category: 'arcade',
    tags: ['phản xạ', 'nâng cấp', 'phiêu lưu'],
    bg: 'linear-gradient(135deg, #1a0a00, #3d1a05)',
    border: '#dc2626',
    file: 'hunter.html',
    featured: true
  },
  {
    id: 'flower-garden',
    name: 'Vườn Hoa Triệu Phú',
    icon: '🌷',
    desc: 'Trồng 25 loại hoa, bán lấy tiền hoặc trưng bày kéo khách! Vé khởi điểm $50, hoa càng quý vé càng đắt!',
    category: 'tycoon',
    tags: ['trồng cây', 'kiếm tiền', 'sưu tập', 'nâng cấp', 'thư giãn'],
    bg: 'linear-gradient(135deg, #2d1b4e, #0f3024)',
    border: '#f0abfc',
    file: 'flower-garden.html',
    featured: true
  },
  {
    id: 'tsunami-zoo',
    name: 'Vườn Thú Sóng Thần',
    icon: '🌊',
    desc: 'Chạy qua 10 map mua thú từ 15-33 kho, né sóng thần về vạch đỏ an toàn, sưu tập 100+ loài!',
    category: 'arcade',
    tags: ['thu thập', 'sinh tồn', 'phản xạ', 'chạy', 'nâng cấp'],
    bg: 'linear-gradient(135deg, #0c4a6e, #082f49)',
    border: '#38bdf8',
    file: 'tsunami-zoo.html',
    featured: true
  },
  {
    id: 'lego',
  ...
  },
  {
    ...
    name: 'Lego Bảng Lớn',
    icon: '🏰',
    desc: 'Bảng cực to 100×150 = 15.000 ô! Xây cả thành phố Lego, có zoom!',
    category: 'puzzle',
    tags: ['sáng tạo', 'xây dựng', 'bảng lớn'],
    bg: 'linear-gradient(135deg, #0f0723, #4c1d95)',
    border: '#c084fc',
    file: 'lego-big.html',
    featured: true
  },
  ...
  },
  {
    ...
    name: 'Công Viên Nước',
    icon: '🏖️',
    desc: '20M vốn, xây 100 loại đồ chơi nước, thuê 10 loại nhân viên, bán vé 10K!',
    category: 'tycoon',
    tags: ['xây dựng', 'quản lý', 'idle', 'bãi biển'],
    bg: 'linear-gradient(135deg, #082f49, #f59e0b)',
    border: '#fde68a',
    file: 'water-park.html',
    featured: true
  },
  {
    id: 'water',
